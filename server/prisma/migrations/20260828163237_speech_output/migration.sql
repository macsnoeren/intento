...
CREATE TABLE "new_UserCommunicationProfile" (
    ...
    "speechHints" BOOLEAN NOT NULL DEFAULT true,
...
INSERT INTO "new_UserCommunicationProfile" ("aiLearningEnabled", "contextIndicator", "conversationStrategy", "iconsPerScreen", "showText", "supportMode", "userId") SELECT "aiLearningEnabled", "contextIndicator", "conversationStrategy", "iconsPerScreen", "showText", "supportMode", "userId" FROM "UserCommunicationProfile";
