...
INSERT INTO "new_AacSymbol" ("category", "concept", "createdAt", "glyph", "id", "label", "searchText", "synonyms") SELECT "category", "concept", "createdAt", "glyph", "id", "label", "searchText", "synonyms" FROM "AacSymbol";
