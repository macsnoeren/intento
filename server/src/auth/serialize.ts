 ...
 * interne lockout-velden; `emailVerified` is afgeleid van `emailVerifiedAt` (T1.4). Gedeeld door
 * de auth- en account-routes zodat de vorm op één plek staat en niet uit elkaar loopt.
 */
