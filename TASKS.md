...
- [ ] **T2.7 Nieuw tijdelijk wachtwoord uitgeven voor een vastgelopen account** *(meerwerk uit T2.6)*
...
- [ ] **T8.3 Platform-operatorconsole: cross-tenant organisatie- en gebruikersbeheer**
...
- [ ] **T8.4 CORS-methoden herstellen (DELETE/PUT/PATCH) + preflight-regressietest**
...
- [ ] **T8.5 Tablet-gespreksscherm blijft hangen op "Laden…" onder React StrictMode**
