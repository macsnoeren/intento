...
- [x] Ik wilde zeggen dat ik iemand lief vind. De AI kwam met "compliment" — dat was goed — maar dan is het einde: "je zegt compliment". Ik wilde door met dat ik die persoon lief vind, maar dat lukt niet. *(opgelost in T10.12: een nog niet beoordeeld AI-begrip is geen eindpunt meer, en bij een leeg punt valt de kandidatenlaag terug op de bibliotheek)*
- [x] Ik kan ook niet tussendoor helemaal opnieuw beginnen als het niet lukt. *(opgelost in T10.12: "🔄 Opnieuw beginnen" staat nu in de balk van elk keuzescherm, niet alleen op het bevestigd-scherm)*
- [x] Ik kreeg "Ik wil brood eten" en dan ja/nee. Ik wilde een boterham met chocopasta erop. Toen ik nee deed kreeg ik appel, banaan etc. Maar dan moet je juist verfijnen — misschien wil ik iets op brood. Of de AI kan ook opties geven voor de verfijning. *(opgelost in T10.12: ❌ Nee doet eerst een verfijnronde waarin de AI om preciezere concepten wordt gevraagd — desnoods nieuwe — en rolt pas bij een tweede ❌ een stap terug)*
